---
name: prompt-caching
description: Cache prompt prefixes and responses to reduce repeated LLM cost and latency.
version: 1.0.0
metadata:
  bd68:                          # bd68 extension
    tags: [context, caching, cost]
    category: context
    activation: conditional      # bd68 extension
    condition: "repetitive requests + cache hit >= 30%"  # bd68 extension
---
