...
description: Optimize effective context capacity through compaction, masking, caching, and partitioning.
version: 1.0.0
metadata:
  bd68:                          # bd68 extension
    tags: [context, optimization, tokens]
    category: context
    activation: always-on        # bd68 extension
---
