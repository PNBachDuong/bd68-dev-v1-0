...
description: Directory-scoped agent memory patterns for long-running work, kept only as a legacy reference.
version: 1.0.0
metadata:
  bd68:                          # bd68 extension
    tags: [memory, hierarchy, deprecated]
    category: memory
    activation: manual           # bd68 extension
---

> **DEPRECATED in v2.0** — Replaced by local MEMORY.md/USER.md pattern.
> Kept for reference. Do not activate unless explicitly requested.
